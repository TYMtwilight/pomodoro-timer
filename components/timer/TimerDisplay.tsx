...
export function TimerDisplay({ timeLeft, initialTime, sessionCount, maxSessions }: TimerDisplayProps) {
  ...
  return (
    <div className={`flex flex-col w-${SVG_WIDTH} h-${SVG_HEIGHT} relative mb-4`}>
